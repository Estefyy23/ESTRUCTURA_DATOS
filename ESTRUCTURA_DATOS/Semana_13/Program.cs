...
class CatalogoRevistas
{
    ...
    {
    "Discover", "Smithsonian", "The Atlantic",
    "Fortune", "The New Yorker", "Psychology Today",  
    "TechCrunch", "The Verge", "IEEE Spectrum", "Astronomy"
    };
    ...
    static void Main()
    {
        while (true)
        {
            ...
            Console.WriteLine("       Programdo por: Estefany Toala \n      ");
